...
const Checkbox = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(Box, { ...getStyles("inner"), mod: { "data-label-position": labelPosition } }, /* @__PURE__ */ React.createElement(
      Box,
      {
        component: "input",
        id: uuid,
    ...
    ), /* @__PURE__ */ React.createElement(Icon, { indeterminate, ...getStyles("icon") }))
  );
});
