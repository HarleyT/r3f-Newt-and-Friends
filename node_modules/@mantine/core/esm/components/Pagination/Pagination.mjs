...
const Pagination = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(PaginationRoot, { ref, total, ...others }, /* @__PURE__ */ React.createElement(Group, { gap }, withEdges && /* @__PURE__ */ React.createElement(PaginationFirst, { icon: firstIcon, ...getControlProps?.("first") }), withControls && /* @__PURE__ */ React.createElement(PaginationPrevious, { icon: previousIcon, ...getControlProps?.("previous") }), /* @__PURE__ */ React.createElement(PaginationItems, { dotsIcon }), withControls && /* @__PURE__ */ React.createElement(PaginationNext, { icon: nextIcon, ...getControlProps?.("next") }), withEdges && /* @__PURE__ */ React.createElement(PaginationLast, { icon: lastIcon, ...getControlProps?.("last") })));
});
