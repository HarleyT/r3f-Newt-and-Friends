...
const ListItem = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { ...ctx.getStyles("itemWrapper", stylesApiProps) }, _icon && /* @__PURE__ */ React.createElement("span", { ...ctx.getStyles("itemIcon", stylesApiProps) }, _icon), /* @__PURE__ */ React.createElement("span", { ...ctx.getStyles("itemLabel", stylesApiProps) }, children))
  );
});
