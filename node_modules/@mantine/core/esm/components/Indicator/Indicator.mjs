...
const Indicator = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(Box, { ref, ...getStyles("root"), mod: [{ inline }, mod], ...others }, !disabled && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
    Box,
    {
