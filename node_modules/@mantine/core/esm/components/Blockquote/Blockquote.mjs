...
const Blockquote = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(Box, { component: "blockquote", ref, ...getStyles("root"), ...others }, icon && /* @__PURE__ */ React.createElement("span", { ...getStyles("icon") }, icon), children, cite && /* @__PURE__ */ React.createElement("cite", { ...getStyles("cite") }, cite));
});
