...
const Switch = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(Box, { component: "span", mod: "reduce-motion", ...getStyles("thumb") }, thumbIcon),
      /* @__PURE__ */ React.createElement("span", { ...getStyles("trackLabel") }, _checked ? onLabel : offLabel)
    )
  );
});
