...
const ColorSwatch = polymorphicFactory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("span", { ...getStyles("alphaOverlay") }),
    withShadow && /* @__PURE__ */ React.createElement("span", { ...getStyles("shadowOverlay") }),
    /* @__PURE__ */ React.createElement("span", { ...getStyles("colorOverlay", { style: { backgroundColor: color } }) }),
    /* @__PURE__ */ React.createElement("span", { ...getStyles("childrenOverlay") }, children)
  );
});
