...
const Dialog = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(Transition, { keepMounted, mounted: opened, ...transitionProps }, (transitionStyles) => /* @__PURE__ */ React.createElement(
      Paper,
      {
        unstyled,
      ...
      withCloseButton && /* @__PURE__ */ React.createElement(CloseButton, { onClick: onClose, unstyled, ...getStyles("closeButton") }),
      children
    ))
  );
});
