...
function HoverCard(props) {
  ...
  return /* @__PURE__ */ React.createElement(HoverCardContextProvider, { value: { openDropdown, closeDropdown } }, /* @__PURE__ */ React.createElement(Popover, { ...others, opened, __staticSelector: "HoverCard" }, children));
}
