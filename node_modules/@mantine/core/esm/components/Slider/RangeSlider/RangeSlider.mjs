...
const RangeSlider = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(SliderProvider, { value: { getStyles } }, /* @__PURE__ */ React.createElement(SliderRoot, { ...others, size, ref, disabled }, /* @__PURE__ */ React.createElement(
    Track,
    {
      offset: positions[0],
  ...
  ), /* @__PURE__ */ React.createElement("input", { type: "hidden", name: `${name}_from`, value: _value[0], ...hiddenInputProps }), /* @__PURE__ */ React.createElement("input", { type: "hidden", name: `${name}_to`, value: _value[1], ...hiddenInputProps })));
});
