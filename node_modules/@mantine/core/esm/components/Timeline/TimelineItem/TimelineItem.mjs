...
const TimelineItem = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { ...ctx.getStyles("itemBody", stylesApiProps) }, title && /* @__PURE__ */ React.createElement("div", { ...ctx.getStyles("itemTitle", stylesApiProps) }, title), /* @__PURE__ */ React.createElement("div", { ...ctx.getStyles("itemContent", stylesApiProps) }, children))
  );
});
