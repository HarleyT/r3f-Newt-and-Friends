...
const MultiSelect = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(Combobox.DropdownTarget, null, /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(Pill.Group, { disabled, unstyled, ...getStyles("pillsList") }, values, /* @__PURE__ */ React.createElement(Combobox.EventsTarget, { autoComplete }, /* @__PURE__ */ React.createElement(
        PillsInput.Field,
        {
          ...rest,
          ref,
