...
const StepperStep = factory((props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    withIcon && /* @__PURE__ */ React.createElement("span", { ...ctx.getStyles("stepWrapper", stylesApi) }, /* @__PURE__ */ React.createElement("span", { ...ctx.getStyles("stepIcon", stylesApi), ...dataAttributes }, /* @__PURE__ */ React.createElement(Transition, { mounted: state === "stepCompleted", transition: "pop", duration: 200 }, (transitionStyles) => /* @__PURE__ */ React.createElement(
      "span",
      {
    ...
    (label || description) && /* @__PURE__ */ React.createElement(
      ...
      label && /* @__PURE__ */ React.createElement("span", { ...ctx.getStyles("stepLabel", stylesApi) }, getStepFragment(label, step)),
      description && /* @__PURE__ */ React.createElement("span", { ...ctx.getStyles("stepDescription", stylesApi) }, getStepFragment(description, step))
    )
  );
});
