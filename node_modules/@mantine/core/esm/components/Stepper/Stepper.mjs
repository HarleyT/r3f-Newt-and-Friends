...
const Stepper = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(StepperProvider, { value: { getStyles, orientation, iconPosition } }, /* @__PURE__ */ React.createElement(Box, { ...getStyles("root"), ref, size, ...others }, /* @__PURE__ */ React.createElement(
    Box,
    {
      ...getStyles("steps"),
      mod: {
    ...
    items
  ), content && /* @__PURE__ */ React.createElement("div", { ...getStyles("content") }, content)));
});
