  ...
  (theme, { radius, color, size, iconColor, variant, autoContrast }) => {
    ...
    return {
      root: {
        ...
        "--checkbox-icon-color": iconColor ? getThemeColor.getThemeColor(iconColor, theme) : getAutoContrastValue.getAutoContrastValue(autoContrast, theme) ? getContrastColor.getContrastColor({ color, theme }) : void 0
      }
    };
  }
);
const Checkbox = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(
    ...
    /* @__PURE__ */ React__default.default.createElement(Box.Box, { ...getStyles("inner"), mod: { "data-label-position": labelPosition } }, /* @__PURE__ */ React__default.default.createElement(
      Box.Box,
      {
        component: "input",
        id: uuid,
    ...
    ), /* @__PURE__ */ React__default.default.createElement(Icon, { indeterminate, ...getStyles("icon") }))
  );
});
