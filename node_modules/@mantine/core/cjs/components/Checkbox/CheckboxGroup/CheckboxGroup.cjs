...
const CheckboxGroup = factory.factory((props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(CheckboxGroup_context.CheckboxGroupProvider, { value: { value: _value, onChange: handleChange, size } }, /* @__PURE__ */ React__default.default.createElement(
    Input.Input.Wrapper,
    {
      size,
      ref,
    ...
    /* @__PURE__ */ React__default.default.createElement(InputsGroupFieldset.InputsGroupFieldset, { role: "group" }, children)
  ));
});
