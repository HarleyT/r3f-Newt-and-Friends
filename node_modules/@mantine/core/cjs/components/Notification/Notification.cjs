...
const Notification = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(
    ...
    icon && !loading && /* @__PURE__ */ React__default.default.createElement("div", { ...getStyles("icon") }, icon),
    loading && /* @__PURE__ */ React__default.default.createElement(Loader.Loader, { size: 28, color, ...getStyles("loader") }),
    /* @__PURE__ */ React__default.default.createElement("div", { ...getStyles("body") }, title && /* @__PURE__ */ React__default.default.createElement("div", { ...getStyles("title") }, title), /* @__PURE__ */ React__default.default.createElement(Box.Box, { ...getStyles("description"), mod: { "data-with-title": !!title } }, children)),
    withCloseButton && /* @__PURE__ */ React__default.default.createElement(
