...
const ColorSwatch = polymorphicFactory.polymorphicFactory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(
    ...
    /* @__PURE__ */ React__default.default.createElement("span", { ...getStyles("alphaOverlay") }),
    withShadow && /* @__PURE__ */ React__default.default.createElement("span", { ...getStyles("shadowOverlay") }),
    /* @__PURE__ */ React__default.default.createElement("span", { ...getStyles("colorOverlay", { style: { backgroundColor: color } }) }),
    /* @__PURE__ */ React__default.default.createElement("span", { ...getStyles("childrenOverlay") }, children)
  );
});
