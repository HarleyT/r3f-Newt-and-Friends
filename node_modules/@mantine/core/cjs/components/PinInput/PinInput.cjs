...
const PinInput = factory.factory((props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(React__default.default.Fragment, null, /* @__PURE__ */ React__default.default.createElement(
    ...
    _value.map((char, index) => /* @__PURE__ */ React__default.default.createElement(
      Input.Input,
      {
        component: "input",
        ...getStyles("pinInput", {
  ...
  ), /* @__PURE__ */ React__default.default.createElement("input", { type: "hidden", name, form, value: _valueToString, ...hiddenInputProps }));
});
