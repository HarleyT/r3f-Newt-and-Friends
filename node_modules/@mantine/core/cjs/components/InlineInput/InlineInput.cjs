  ...
  ({
    ...
    return /* @__PURE__ */ React__default.default.createElement(
      ...
      /* @__PURE__ */ React__default.default.createElement(
        ...
        children,
        /* @__PURE__ */ React__default.default.createElement("div", { ...getStyles("labelWrapper"), "data-disabled": disabled || void 0 }, label && /* @__PURE__ */ React__default.default.createElement(
          Box.Box,
          {
          ...
          label
        ), description && /* @__PURE__ */ React__default.default.createElement(Input.Input.Description, { size, __inheritStyles: false, ...getStyles("description") }, description), error && error !== "boolean" && /* @__PURE__ */ React__default.default.createElement(Input.Input.Error, { size, __inheritStyles: false, ...getStyles("error") }, error))
      )
    );
  }
);
