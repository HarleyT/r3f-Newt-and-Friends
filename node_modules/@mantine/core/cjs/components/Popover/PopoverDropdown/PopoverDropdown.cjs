...
const PopoverDropdown = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(OptionalPortal.OptionalPortal, { ...ctx.portalProps, withinPortal: ctx.withinPortal }, /* @__PURE__ */ React__default.default.createElement(
    ...
    (transitionStyles) => /* @__PURE__ */ React__default.default.createElement(FocusTrap.FocusTrap, { active: ctx.trapFocus }, /* @__PURE__ */ React__default.default.createElement(
      Box.Box,
      {
        ...accessibleProps,
        ...others,
