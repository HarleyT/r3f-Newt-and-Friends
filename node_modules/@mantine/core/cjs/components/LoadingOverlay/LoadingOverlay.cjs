...
const LoadingOverlay = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(Transition.Transition, { transition: "fade", ...transitionProps, mounted: !!visible }, (transitionStyles) => /* @__PURE__ */ React__default.default.createElement(Box.Box, { ...getStyles("root", { style: transitionStyles }), ref, ...others }, /* @__PURE__ */ React__default.default.createElement(Loader.Loader, { ...getStyles("loader"), unstyled, ...loaderProps }), /* @__PURE__ */ React__default.default.createElement(
    Overlay.Overlay,
    {
      ..._overlayProps,
      ...getStyles("overlay"),
