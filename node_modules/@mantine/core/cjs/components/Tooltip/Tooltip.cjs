...
const Tooltip = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(React__default.default.Fragment, null, /* @__PURE__ */ React__default.default.createElement(OptionalPortal.OptionalPortal, { ...portalProps, withinPortal }, /* @__PURE__ */ React__default.default.createElement(
    ...
    (transitionStyles) => /* @__PURE__ */ React__default.default.createElement(
      Box.Box,
      {
        ...others,
        variant,
