...
function HoverCardDropdown(props) {
  ...
  return /* @__PURE__ */ React__default.default.createElement(Popover.Popover.Dropdown, { onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave, ...others }, children);
}
