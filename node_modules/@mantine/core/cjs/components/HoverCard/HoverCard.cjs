...
function HoverCard(props) {
  ...
  return /* @__PURE__ */ React__default.default.createElement(HoverCard_context.HoverCardContextProvider, { value: { openDropdown, closeDropdown } }, /* @__PURE__ */ React__default.default.createElement(Popover.Popover, { ...others, opened, __staticSelector: "HoverCard" }, children));
}
