...
const InputWrapper = factory.factory((_props, ref) => {
  ...
  const _label = label && /* @__PURE__ */ React__default.default.createElement(
  ...
  const _description = hasDescription && /* @__PURE__ */ React__default.default.createElement(
  ...
  const _input = /* @__PURE__ */ React__default.default.createElement(React__default.default.Fragment, { key: "input" }, inputContainer(children));
  const _error = hasError && /* @__PURE__ */ React__default.default.createElement(
