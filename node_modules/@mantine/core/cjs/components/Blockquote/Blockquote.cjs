...
const Blockquote = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(Box.Box, { component: "blockquote", ref, ...getStyles("root"), ...others }, icon && /* @__PURE__ */ React__default.default.createElement("span", { ...getStyles("icon") }, icon), children, cite && /* @__PURE__ */ React__default.default.createElement("cite", { ...getStyles("cite") }, cite));
});
