...
const SegmentedControl = factory.factory((_props, ref) => {
  ...
  const controls = _data.map((item) => /* @__PURE__ */ React__default.default.createElement(
    Box.Box,
    {
      ...getStyles("control"),
    ...
    /* @__PURE__ */ React__default.default.createElement(
      ...
      /* @__PURE__ */ React__default.default.createElement("span", { ...getStyles("innerLabel") }, item.label)
    )
  ));
  ...
  return /* @__PURE__ */ React__default.default.createElement(
    ...
    typeof _value === "string" && /* @__PURE__ */ React__default.default.createElement(
