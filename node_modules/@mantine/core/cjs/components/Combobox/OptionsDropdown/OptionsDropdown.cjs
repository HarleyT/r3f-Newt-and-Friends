...
function Option({
  ...
  if (!isOptionsGroup.isOptionsGroup(data)) {
    ...
    const check = withCheckIcon && checked && /* @__PURE__ */ React__default.default.createElement(CheckIcon.CheckIcon, { className: Combobox_module.optionsDropdownCheckIcon });
    const defaultContent = /* @__PURE__ */ React__default.default.createElement(React__default.default.Fragment, null, checkIconPosition === "left" && check, /* @__PURE__ */ React__default.default.createElement("span", null, data.label), checkIconPosition === "right" && check);
  ...
  const options = data.items.map((item) => /* @__PURE__ */ React__default.default.createElement(
    Option,
    {
      data: item,
      value,
  ...
  return /* @__PURE__ */ React__default.default.createElement(Combobox.Combobox.Group, { label: data.group }, options);
}
function OptionsDropdown({
  ...
  const options = filteredData.map((item) => /* @__PURE__ */ React__default.default.createElement(
    Option,
    {
      data: item,
  ...
  return /* @__PURE__ */ React__default.default.createElement(Combobox.Combobox.Dropdown, { hidden: hidden || hiddenWhenEmpty && isEmpty }, /* @__PURE__ */ React__default.default.createElement(Combobox.Combobox.Options, { labelledBy: labelId }, withScrollArea ? /* @__PURE__ */ React__default.default.createElement(
    ...
    options
  ) : options, isEmpty && nothingFoundMessage && /* @__PURE__ */ React__default.default.createElement(Combobox.Combobox.Empty, null, nothingFoundMessage)));
}
