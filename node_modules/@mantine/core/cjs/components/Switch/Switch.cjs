...
const Switch = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(
    ...
    /* @__PURE__ */ React__default.default.createElement(
      ...
      /* @__PURE__ */ React__default.default.createElement(Box.Box, { component: "span", mod: "reduce-motion", ...getStyles("thumb") }, thumbIcon),
      /* @__PURE__ */ React__default.default.createElement("span", { ...getStyles("trackLabel") }, _checked ? onLabel : offLabel)
    )
  );
});
