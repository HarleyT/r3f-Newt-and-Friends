...
const SwitchGroup = factory.factory((props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(SwitchGroup_context.SwitchGroupProvider, { value: { value: _value, onChange: handleChange, size } }, /* @__PURE__ */ React__default.default.createElement(
    Input.Input.Wrapper,
    {
      size,
      ref,
