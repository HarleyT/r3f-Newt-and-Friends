...
const ModalRoot = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(Modal_context.ModalProvider, { value: { yOffset, scrollAreaComponent, getStyles, fullScreen } }, /* @__PURE__ */ React__default.default.createElement(
    ModalBase.ModalBase,
    {
      ref,
      ...getStyles("root"),
