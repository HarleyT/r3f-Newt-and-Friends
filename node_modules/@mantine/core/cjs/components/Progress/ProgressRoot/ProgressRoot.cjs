...
const ProgressRoot = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(Progress_context.ProgressProvider, { value: { getStyles, autoContrast } }, /* @__PURE__ */ React__default.default.createElement(Box.Box, { ref, ...getStyles("root"), ...others }));
});
