...
const PasswordInput = factory.factory((_props, ref) => {
  ...
  const visibilityToggleButton = /* @__PURE__ */ React__default.default.createElement(
    ...
    /* @__PURE__ */ React__default.default.createElement(VisibilityToggleIcon, { reveal: _visible })
  );
