...
const TimelineItem = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(
    ...
    /* @__PURE__ */ React__default.default.createElement("div", { ...ctx.getStyles("itemBody", stylesApiProps) }, title && /* @__PURE__ */ React__default.default.createElement("div", { ...ctx.getStyles("itemTitle", stylesApiProps) }, title), /* @__PURE__ */ React__default.default.createElement("div", { ...ctx.getStyles("itemContent", stylesApiProps) }, children))
  );
});
