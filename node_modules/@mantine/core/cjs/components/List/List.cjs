...
const List = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(List_context.ListProvider, { value: { center, icon, getStyles } }, /* @__PURE__ */ React__default.default.createElement(
    Box.Box,
    {
