...
function Curve({
  ...
  return /* @__PURE__ */ React__default.default.createElement(Tooltip.Tooltip.Floating, { disabled: !tooltip, label: tooltip }, /* @__PURE__ */ React__default.default.createElement(
    Box.Box,
    {
      component: "circle",
      ...others,
