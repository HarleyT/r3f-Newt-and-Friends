...
const RingProgress = factory.factory((_props, ref) => {
  ...
  const curves = getCurves.getCurves({
    ...
    rootColor
  }).map(({ data, sum, root, lineRoundCaps, offset }, index) => /* @__PURE__ */ React__default.default.createElement(
    Curve.Curve,
    {
      ...data,
      key: index,
  ...
  return /* @__PURE__ */ React__default.default.createElement(Box.Box, { ...getStyles("root"), size, ref, ...others }, /* @__PURE__ */ React__default.default.createElement("svg", { ...getStyles("svg") }, curves), label && /* @__PURE__ */ React__default.default.createElement("div", { ...getStyles("label") }, label));
});
