...
const AvatarGroup = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(AvatarGroup_context.AvatarGroupProvider, { value: true }, /* @__PURE__ */ React__default.default.createElement(Box.Box, { ref, ...getStyles("group"), ...others }));
});
