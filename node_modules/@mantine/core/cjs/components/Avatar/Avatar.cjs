...
const Avatar = polymorphicFactory.polymorphicFactory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(
    ...
    error ? /* @__PURE__ */ React__default.default.createElement("span", { ...getStyles("placeholder"), title: alt }, children || /* @__PURE__ */ React__default.default.createElement(AvatarPlaceholderIcon.AvatarPlaceholderIcon, null)) : /* @__PURE__ */ React__default.default.createElement(
      "img",
      {
        ...imageProps,
        ...getStyles("image"),
