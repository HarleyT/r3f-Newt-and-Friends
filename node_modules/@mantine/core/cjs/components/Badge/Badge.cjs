...
const Badge = polymorphicFactory.polymorphicFactory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(
    ...
    leftSection && /* @__PURE__ */ React__default.default.createElement("span", { ...getStyles("section"), "data-position": "left" }, leftSection),
    /* @__PURE__ */ React__default.default.createElement("span", { ...getStyles("label") }, children),
    rightSection && /* @__PURE__ */ React__default.default.createElement("span", { ...getStyles("section"), "data-position": "right" }, rightSection)
  );
});
