...
const PaginationDots = factory.factory((_props, ref) => {
  ...
  const Icon = icon;
  return /* @__PURE__ */ React__default.default.createElement(Box.Box, { ref, ...ctx.getStyles("dots", { className, style, styles, classNames }), ...others }, /* @__PURE__ */ React__default.default.createElement(
    Icon,
    {
      style: {
