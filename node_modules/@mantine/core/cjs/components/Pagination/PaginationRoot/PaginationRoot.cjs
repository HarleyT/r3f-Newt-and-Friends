...
const varsResolver = createVarsResolver.createVarsResolver(
  (theme, { size, radius, color, autoContrast }) => ({
    root: {
      ...
      "--pagination-active-color": getAutoContrastValue.getAutoContrastValue(autoContrast, theme) ? getContrastColor.getContrastColor({ color, theme }) : void 0
    }
  })
);
const PaginationRoot = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(
    ...
    /* @__PURE__ */ React__default.default.createElement(Box.Box, { ref, ...getStyles("root"), ...others })
  );
});
