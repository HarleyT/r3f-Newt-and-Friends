...
const Pagination = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(PaginationRoot.PaginationRoot, { ref, total, ...others }, /* @__PURE__ */ React__default.default.createElement(Group.Group, { gap }, withEdges && /* @__PURE__ */ React__default.default.createElement(PaginationEdges.PaginationFirst, { icon: firstIcon, ...getControlProps?.("first") }), withControls && /* @__PURE__ */ React__default.default.createElement(PaginationEdges.PaginationPrevious, { icon: previousIcon, ...getControlProps?.("previous") }), /* @__PURE__ */ React__default.default.createElement(PaginationItems.PaginationItems, { dotsIcon }), withControls && /* @__PURE__ */ React__default.default.createElement(PaginationEdges.PaginationNext, { icon: nextIcon, ...getControlProps?.("next") }), withEdges && /* @__PURE__ */ React__default.default.createElement(PaginationEdges.PaginationLast, { icon: lastIcon, ...getControlProps?.("last") })));
});
