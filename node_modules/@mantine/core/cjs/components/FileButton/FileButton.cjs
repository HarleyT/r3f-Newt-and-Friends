...
const FileButton = React.forwardRef(
  (props, ref) => {
    ...
    return /* @__PURE__ */ React__default.default.createElement(React__default.default.Fragment, null, children({ onClick, ...others }), /* @__PURE__ */ React__default.default.createElement(
      "input",
      {
        style: { display: "none" },
        type: "file",
