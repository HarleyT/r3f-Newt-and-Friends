...
const MultiSelect = factory.factory((_props, ref) => {
  ...
  const values = _value.map((item, index) => /* @__PURE__ */ React__default.default.createElement(
    Pill.Pill,
    {
      key: `${item}-${index}`,
  ...
  const clearButton = clearable && _value.length > 0 && !disabled && !readOnly && /* @__PURE__ */ React__default.default.createElement(
  ...
  return /* @__PURE__ */ React__default.default.createElement(React__default.default.Fragment, null, /* @__PURE__ */ React__default.default.createElement(
    ...
    /* @__PURE__ */ React__default.default.createElement(Combobox.Combobox.DropdownTarget, null, /* @__PURE__ */ React__default.default.createElement(
      PillsInput.PillsInput,
      {
        ...
        disabled,
        radius,
        rightSection: rightSection || clearButton || /* @__PURE__ */ React__default.default.createElement(Combobox.Combobox.Chevron, { size, error, unstyled }),
      ...
      /* @__PURE__ */ React__default.default.createElement(Pill.Pill.Group, { disabled, unstyled, ...getStyles("pillsList") }, values, /* @__PURE__ */ React__default.default.createElement(Combobox.Combobox.EventsTarget, { autoComplete }, /* @__PURE__ */ React__default.default.createElement(
