...
const DefaultValue = ({ value }) => /* @__PURE__ */ React__default.default.createElement("div", { style: { overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" } }, Array.isArray(value) ? value.map((file) => file.name).join(", ") : value?.name);
const defaultProps = {
...
const _FileInput = factory.factory((_props, ref) => {
  ...
  const _rightSection = rightSection || (clearable && hasValue && !readOnly ? /* @__PURE__ */ React__default.default.createElement(
  ...
  return /* @__PURE__ */ React__default.default.createElement(
    ...
    (fileButtonProps) => /* @__PURE__ */ React__default.default.createElement(
      InputBase.InputBase,
      {
        component: "button",
        ref,
      ...
      !hasValue ? /* @__PURE__ */ React__default.default.createElement(Input.Input.Placeholder, null, placeholder) : /* @__PURE__ */ React__default.default.createElement(ValueComponent, { value: _value })
    )
  );
});
