...
const Swatches = React.forwardRef(
  ({
    ...
    const colors = data.map((color, index) => /* @__PURE__ */ React__default.default.createElement(
    ...
    return /* @__PURE__ */ React__default.default.createElement(Box.Box, { ...ctx.getStyles("swatches"), ref, ...others }, colors);
  }
);
