...
const getStepFragment = (Fragment, step) => {
  if (typeof Fragment === "function") {
    return /* @__PURE__ */ React__default.default.createElement(Fragment, { step: step || 0 });
  }
  return Fragment;
};
const defaultProps = {
...
const StepperStep = factory.factory((props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(
    ...
    withIcon && /* @__PURE__ */ React__default.default.createElement("span", { ...ctx.getStyles("stepWrapper", stylesApi) }, /* @__PURE__ */ React__default.default.createElement("span", { ...ctx.getStyles("stepIcon", stylesApi), ...dataAttributes }, /* @__PURE__ */ React__default.default.createElement(Transition.Transition, { mounted: state === "stepCompleted", transition: "pop", duration: 200 }, (transitionStyles) => /* @__PURE__ */ React__default.default.createElement(
      "span",
      {
      ...
      ) : getStepFragment(completedIcon, step) || /* @__PURE__ */ React__default.default.createElement(CheckIcon.CheckIcon, { size: "60%" })
    )), state !== "stepCompleted" ? loading ? /* @__PURE__ */ React__default.default.createElement(
      Loader.Loader,
      {
        ...ctx.getStyles("stepLoader", stylesApi),
        size: "calc(var(--stepper-icon-size) / 2)",
    ...
    ) : getStepFragment(_icon || icon, step) : null), orientation === "vertical" && /* @__PURE__ */ React__default.default.createElement(
      "span",
      {
    ...
    (label || description) && /* @__PURE__ */ React__default.default.createElement(
      "span",
      {
      ...
      label && /* @__PURE__ */ React__default.default.createElement("span", { ...ctx.getStyles("stepLabel", stylesApi) }, getStepFragment(label, step)),
      description && /* @__PURE__ */ React__default.default.createElement("span", { ...ctx.getStyles("stepDescription", stylesApi) }, getStepFragment(description, step))
    )
  );
});
