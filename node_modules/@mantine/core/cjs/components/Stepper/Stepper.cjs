...
const varsResolver = createVarsResolver.createVarsResolver(
  (theme, { color, iconSize, size, contentPadding, radius, autoContrast }) => ({
    root: {
      ...
      "--stepper-icon-color": getAutoContrastValue.getAutoContrastValue(autoContrast, theme) ? getContrastColor.getContrastColor({ color, theme }) : void 0,
...
const Stepper = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(Stepper_context.StepperProvider, { value: { getStyles, orientation, iconPosition } }, /* @__PURE__ */ React__default.default.createElement(Box.Box, { ...getStyles("root"), ref, size, ...others }, /* @__PURE__ */ React__default.default.createElement(
    Box.Box,
    {
      ...getStyles("steps"),
      mod: {
    ...
    items
  ), content && /* @__PURE__ */ React__default.default.createElement("div", { ...getStyles("content") }, content)));
});
