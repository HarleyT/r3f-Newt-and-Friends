...
const PillGroup = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(PillGroup_context.PillGroupProvider, { value: { size: _size, disabled } }, /* @__PURE__ */ React__default.default.createElement(Box.Box, { ref, size: _size, ...getStyles("group"), ...others }));
});
