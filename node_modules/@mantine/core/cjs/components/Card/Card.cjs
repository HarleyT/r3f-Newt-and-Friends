...
const Card = polymorphicFactory.polymorphicFactory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(Card_context.CardProvider, { value: { getStyles } }, /* @__PURE__ */ React__default.default.createElement(Paper.Paper, { ref, unstyled, ...getStyles("root"), ...others }, content));
});
