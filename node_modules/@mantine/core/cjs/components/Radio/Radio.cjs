  ...
  (theme, { size, radius, color, iconColor, variant, autoContrast }) => {
    ...
    return {
      root: {
        ...
        "--radio-icon-color": iconColor ? getThemeColor.getThemeColor(iconColor, theme) : getAutoContrastValue.getAutoContrastValue(autoContrast, theme) ? getContrastColor.getContrastColor({ color, theme }) : void 0,
...
const Radio = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(
    ...
    /* @__PURE__ */ React__default.default.createElement(Box.Box, { ...getStyles("inner"), mod: { "label-position": labelPosition } }, /* @__PURE__ */ React__default.default.createElement(
      Box.Box,
      {
    ...
    ), /* @__PURE__ */ React__default.default.createElement(Icon, { ...getStyles("icon"), "aria-hidden": true }))
  );
});
