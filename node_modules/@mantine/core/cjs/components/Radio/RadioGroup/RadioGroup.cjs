...
const RadioGroup = factory.factory((props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(RadioGroup_context.RadioGroupProvider, { value: { value: _value, onChange: handleChange, size, name: _name } }, /* @__PURE__ */ React__default.default.createElement(
    Input.Input.Wrapper,
    {
      size,
      ref,
    ...
    /* @__PURE__ */ React__default.default.createElement(InputsGroupFieldset.InputsGroupFieldset, { role: "radiogroup" }, children)
  ));
});
