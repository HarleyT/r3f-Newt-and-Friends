...
const defaultProps = {
  ...
  variant: "default",
  chevron: /* @__PURE__ */ React__default.default.createElement(AccordionChevron.AccordionChevron, null)
};
...
function Accordion(_props) {
  ...
  return /* @__PURE__ */ React__default.default.createElement(
    ...
    /* @__PURE__ */ React__default.default.createElement(Box.Box, { ...getStyles("root"), id: uid, ...others, variant, "data-accordion": true }, children)
  );
}
