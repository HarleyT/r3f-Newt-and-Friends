...
const AccordionItem = factory.factory((props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(AccordionItem_context.AccordionItemProvider, { value: { value } }, /* @__PURE__ */ React__default.default.createElement(
    Box.Box,
    {
      ref,
