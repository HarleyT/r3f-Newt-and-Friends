...
const AccordionControl = factory.factory((props, ref) => {
  ...
  const content = /* @__PURE__ */ React__default.default.createElement(
    ...
    /* @__PURE__ */ React__default.default.createElement("span", { ...ctx.getStyles("label", { classNames, styles }) }, children),
  ...
  return shouldWrapWithHeading ? /* @__PURE__ */ React__default.default.createElement(Heading, { ...ctx.getStyles("itemTitle", { classNames, styles }) }, content) : content;
});
