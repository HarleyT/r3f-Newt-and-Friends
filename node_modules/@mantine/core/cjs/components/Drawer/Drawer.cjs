...
const Drawer = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(DrawerRoot.DrawerRoot, { ref, ...others }, withOverlay && /* @__PURE__ */ React__default.default.createElement(DrawerOverlay.DrawerOverlay, { ...overlayProps }), /* @__PURE__ */ React__default.default.createElement(DrawerContent.DrawerContent, null, hasHeader && /* @__PURE__ */ React__default.default.createElement(DrawerHeader.DrawerHeader, null, title && /* @__PURE__ */ React__default.default.createElement(DrawerTitle.DrawerTitle, null, title), withCloseButton && /* @__PURE__ */ React__default.default.createElement(DrawerCloseButton.DrawerCloseButton, { ...closeButtonProps })), /* @__PURE__ */ React__default.default.createElement(DrawerBody.DrawerBody, null, children)));
});
