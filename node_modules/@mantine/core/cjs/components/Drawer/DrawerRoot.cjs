...
const DrawerRoot = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(Drawer_context.DrawerProvider, { value: { scrollAreaComponent, getStyles, radius } }, /* @__PURE__ */ React__default.default.createElement(
    ModalBase.ModalBase,
    {
      ref,
      ...getStyles("root"),
