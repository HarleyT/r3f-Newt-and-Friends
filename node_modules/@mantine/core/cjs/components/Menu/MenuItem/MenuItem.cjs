...
const MenuItem = polymorphicFactory.polymorphicFactory((props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(
    ...
    leftSection && /* @__PURE__ */ React__default.default.createElement("div", { ...ctx.getStyles("itemSection", { styles, classNames }), "data-position": "left" }, leftSection),
    children && /* @__PURE__ */ React__default.default.createElement("div", { ...ctx.getStyles("itemLabel", { styles, classNames }) }, children),
    rightSection && /* @__PURE__ */ React__default.default.createElement("div", { ...ctx.getStyles("itemSection", { styles, classNames }), "data-position": "right" }, rightSection)
  );
});
