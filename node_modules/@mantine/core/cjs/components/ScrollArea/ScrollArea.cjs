...
const ScrollArea = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(
    ...
    (scrollbars === "xy" || scrollbars === "x") && /* @__PURE__ */ React__default.default.createElement(
      ...
      /* @__PURE__ */ React__default.default.createElement(ScrollAreaThumb.ScrollAreaThumb, { ...getStyles("thumb") })
    ),
    (scrollbars === "xy" || scrollbars === "y") && /* @__PURE__ */ React__default.default.createElement(
      ScrollAreaScrollbar.ScrollAreaScrollbar,
      {
        ...getStyles("scrollbar"),
...
const ScrollAreaAutosize = factory.factory((props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(Box.Box, { ...others, ref, style: [{ display: "flex", overflow: "auto" }, style] }, /* @__PURE__ */ React__default.default.createElement(Box.Box, { style: { display: "flex", flexDirection: "column", flex: 1 } }, /* @__PURE__ */ React__default.default.createElement(
    ScrollArea,
    {
      classNames,
      styles,
