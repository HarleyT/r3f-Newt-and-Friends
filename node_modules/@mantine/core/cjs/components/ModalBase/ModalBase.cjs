...
const ModalBase = React.forwardRef(
  ({
    ...
    return /* @__PURE__ */ React__default.default.createElement(OptionalPortal.OptionalPortal, { ...portalProps, withinPortal }, /* @__PURE__ */ React__default.default.createElement(
      ...
      /* @__PURE__ */ React__default.default.createElement(reactRemoveScroll.RemoveScroll, { enabled: shouldLockScroll && lockScroll, ...removeScrollProps }, /* @__PURE__ */ React__default.default.createElement(
        Box.Box,
        {
          ref,
          ...others,
