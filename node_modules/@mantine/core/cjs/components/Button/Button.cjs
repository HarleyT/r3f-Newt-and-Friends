...
const Button = polymorphicFactory.polymorphicFactory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(
    ...
    /* @__PURE__ */ React__default.default.createElement(Transition.Transition, { mounted: !!loading, transition: loaderTransition, duration: 150 }, (transitionStyles) => /* @__PURE__ */ React__default.default.createElement(Box.Box, { component: "span", ...getStyles("loader", { style: transitionStyles }), "aria-hidden": true }, /* @__PURE__ */ React__default.default.createElement(
      Loader.Loader,
      {
    ...
    /* @__PURE__ */ React__default.default.createElement("span", { ...getStyles("inner") }, leftSection && /* @__PURE__ */ React__default.default.createElement(Box.Box, { component: "span", ...getStyles("section"), mod: { position: "left" } }, leftSection), /* @__PURE__ */ React__default.default.createElement(Box.Box, { component: "span", mod: { loading }, ...getStyles("label") }, children), rightSection && /* @__PURE__ */ React__default.default.createElement(Box.Box, { component: "span", ...getStyles("section"), mod: { position: "right" } }, rightSection))
  );
});
