...
const InputBase = polymorphicFactory.polymorphicFactory((props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(Input.Input.Wrapper, { ...wrapperProps }, /* @__PURE__ */ React__default.default.createElement(Input.Input, { ...inputProps, ...others, ref }));
});
