...
const Breadcrumbs = factory.factory((_props, ref) => {
  ...
  const items = React__default.default.Children.toArray(children).reduce(
    (acc, child, index, array) => {
      const item = isElement.isElement(child) ? React__default.default.cloneElement(child, {
        ...getStyles("breadcrumb", { className: child.props?.className }),
        key: index
      }) : /* @__PURE__ */ React__default.default.createElement("div", { ...getStyles("breadcrumb"), key: index }, child);
      acc.push(item);
      if (index !== array.length - 1) {
        acc.push(
          /* @__PURE__ */ React__default.default.createElement(Box.Box, { ...getStyles("separator"), key: `separator-${index}` }, separator)
        );
      }
      return acc;
    },
  ...
  return /* @__PURE__ */ React__default.default.createElement(Box.Box, { ref, ...getStyles("root"), ...others }, items);
});
