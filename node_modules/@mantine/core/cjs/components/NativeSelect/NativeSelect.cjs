...
const NativeSelect = factory.factory((props, ref) => {
  ...
  const options = getParsedComboboxData.getParsedComboboxData(data).map((item, index) => /* @__PURE__ */ React__default.default.createElement(NativeSelectOption.NativeSelectOption, { key: index, data: item }));
  return /* @__PURE__ */ React__default.default.createElement(
    InputBase.InputBase,
    {
      ...
      error,
      unstyled,
      rightSection: rightSection || /* @__PURE__ */ React__default.default.createElement(ComboboxChevron.ComboboxChevron, { size, error, unstyled })
    },
    children || options
  );
});
