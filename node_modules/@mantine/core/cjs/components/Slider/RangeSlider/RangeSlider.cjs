...
const RangeSlider = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(Slider_context.SliderProvider, { value: { getStyles } }, /* @__PURE__ */ React__default.default.createElement(SliderRoot.SliderRoot, { ...others, size, ref, disabled }, /* @__PURE__ */ React__default.default.createElement(
    Track.Track,
    {
      offset: positions[0],
  ...
  ), /* @__PURE__ */ React__default.default.createElement("input", { type: "hidden", name: `${name}_from`, value: _value[0], ...hiddenInputProps }), /* @__PURE__ */ React__default.default.createElement("input", { type: "hidden", name: `${name}_to`, value: _value[1], ...hiddenInputProps })));
});
