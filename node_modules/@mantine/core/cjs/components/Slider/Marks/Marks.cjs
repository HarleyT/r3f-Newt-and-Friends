...
function Marks({ marks, min, max, disabled, value, offset, inverted }) {
  ...
  const items = marks.map((mark, index) => /* @__PURE__ */ React__default.default.createElement(
    Box.Box,
    {
    ...
    mark.label && /* @__PURE__ */ React__default.default.createElement("div", { ...getStyles("markLabel") }, mark.label)
  ));
  return /* @__PURE__ */ React__default.default.createElement("div", null, items);
}
