...
const Dialog = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(
    ...
    /* @__PURE__ */ React__default.default.createElement(Transition.Transition, { keepMounted, mounted: opened, ...transitionProps }, (transitionStyles) => /* @__PURE__ */ React__default.default.createElement(
      Paper.Paper,
      {
        unstyled,
      ...
      withCloseButton && /* @__PURE__ */ React__default.default.createElement(CloseButton.CloseButton, { onClick: onClose, unstyled, ...getStyles("closeButton") }),
      children
    ))
  );
});
