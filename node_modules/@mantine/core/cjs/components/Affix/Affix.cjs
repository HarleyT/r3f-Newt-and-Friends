...
const varsResolver = createVarsResolver.createVarsResolver((_, { zIndex, position }) => ({
  root: {
    ...
    "--affix-top": rem.rem(position?.top),
    "--affix-left": rem.rem(position?.left),
    "--affix-bottom": rem.rem(position?.bottom),
    "--affix-right": rem.rem(position?.right)
  }
}));
const Affix = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(OptionalPortal.OptionalPortal, { ...portalProps, withinPortal }, /* @__PURE__ */ React__default.default.createElement(Box.Box, { ref, ...getStyles("root"), ...others }));
});
