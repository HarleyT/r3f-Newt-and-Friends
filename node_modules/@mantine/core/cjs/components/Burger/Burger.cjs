...
const Burger = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(UnstyledButton.UnstyledButton, { ...getStyles("root"), ref, ...others }, /* @__PURE__ */ React__default.default.createElement(Box.Box, { mod: ["reduce-motion", { opened }], ...getStyles("burger") }), children);
});
