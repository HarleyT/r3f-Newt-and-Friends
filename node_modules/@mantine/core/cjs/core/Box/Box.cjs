...
const _Box = React.forwardRef(
  ({
    ...
    return /* @__PURE__ */ React__default.default.createElement(React__default.default.Fragment, null, parsedStyleProps.hasResponsiveStyles && /* @__PURE__ */ React__default.default.createElement(
    ...
    ), typeof renderRoot === "function" ? renderRoot(props) : /* @__PURE__ */ React__default.default.createElement(Element, { ...props }));
  }
);
