...
function getStyle({
  ...
  return {
    ...getThemeStyles.getThemeStyles({ theme, themeName, props, stylesCtx, selector }),
    ...resolveStyles.resolveStyles({ theme, styles, props, stylesCtx })[selector],
    ...resolveStyles.resolveStyles({ theme, styles: options?.styles, props: options?.props || props, stylesCtx })[selector],
