...
var getContrastColor = require('../color-functions/get-contrast-color/get-contrast-color.cjs');
var getCssColorVariables = require('./get-css-color-variables.cjs');
var virtualColor = require('./virtual-color/virtual-color.cjs');
...
const defaultCssVariablesResolver = (theme) => {
  ...
  const result = {
    ...
    light: {
      "--mantine-primary-color-contrast": getContrastColor.getPrimaryContrastColor(theme, "light"),
    ...
    dark: {
      "--mantine-primary-color-contrast": getContrastColor.getPrimaryContrastColor(theme, "dark"),
  ...
  keys.keys(theme.colors).forEach((color) => {
    ...
    if (virtualColor.isVirtualColor(value)) {
      Object.assign(
        result.light,
...
//# sourceMappingURL=default-css-variables-resolver.cjs.map
